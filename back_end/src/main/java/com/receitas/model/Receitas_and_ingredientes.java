...
public class Receitas_and_ingredientes {
    ...
    public Receitas_and_ingredientes(Medida medida_id, Ingrediente ingrediente_id, Receita receita_id, int porcoes) {
    ...
    public Receitas_and_ingredientes(Long id_composicao, Medida medida_id, Ingrediente ingrediente_id, Receita receita_id, int porcoes) {
